...
pub(crate) fn validate_surface_id(id: &str) -> Result<(), BackendError> {
    if id.trim().is_empty() {
...
pub(crate) fn validate_surface_size(width: u32, height: u32) -> Result<(), BackendError> {
    if width == 0 || height == 0 {
        Err(BackendError::new(
...
pub(crate) fn validate_dpi_scale(dpi_scale: f32) -> Result<(), BackendError> {
...
pub(crate) fn validate_geometry(geometry: Geometry) -> Result<(), BackendError> {
...
pub(crate) fn validate_opacity(opacity: f32) -> Result<(), BackendError> {
