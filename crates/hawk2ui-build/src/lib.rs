...
pub use artifact::{
    ...
    AssetManifestEntry, BuildMetadata, CompiledAssetRecord, CompiledFrameworkRecord,
    CompiledScriptRecord, CompiledStyleRecord, SealedArtifact, SealedArtifactError,
...
pub use manifest::{
    HawkManifest, ManifestError, PackageTarget, PinParamIds, SourceFramework, pin_param_ids,
};
