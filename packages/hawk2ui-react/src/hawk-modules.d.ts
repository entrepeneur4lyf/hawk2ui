...
declare module "hawk:secrets" {
  ...
  const secrets: {
    ...
    readonly serializeSecretOptions: typeof serializeSecretOptions;
  };
...
declare module "hawk:files" {
  ...
  const files: {
    ...
    readonly pickFile: typeof pickFile;
    readonly pickFolder: typeof pickFolder;
    readonly watch: typeof watch;
    readonly importFile: typeof importFile;
    readonly exportFile: typeof exportFile;
  };
...
declare module "hawk:ai" {
  export function callProvider(provider: string, payload?: unknown, options?: HawkJsonObject): Promise<unknown>;
  export function streamProvider(provider: string, payload?: unknown, options?: HawkJsonObject): AsyncIterable<unknown>;
}
